...
namespace Sol_Demo.Models
{
    public class UserModel
    {
        ...
        private class MobileNoValidation : ValidationAttribute, IClientModelValidator
        {
            // Server Side
            ...
            public void AddValidation(ClientModelValidationContext context)
            {
                ...
                context.Attributes.Add("data-val-mobileno", "Mobile no does not start with 0");
                context.Attributes.Add("data-val-mobileno-length", "10 digit no allowed only");
            }
        }
    }
}